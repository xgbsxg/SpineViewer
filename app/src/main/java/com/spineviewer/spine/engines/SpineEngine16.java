...
import com.spineviewer.spine.runtime.v16.Animation;
import com.spineviewer.spine.runtime.v16.AnimationState;
import com.spineviewer.spine.runtime.v16.AnimationStateData;
import com.spineviewer.spine.runtime.v16.Skeleton;
import com.spineviewer.spine.runtime.v16.SkeletonData;
import com.spineviewer.spine.runtime.v16.SkeletonJson;
import com.spineviewer.spine.runtime.v16.SkeletonBinary;
import com.spineviewer.spine.runtime.v16.SkeletonRenderer;
import com.spineviewer.spine.runtime.v16.SkeletonRendererDebug;
import com.spineviewer.spine.runtime.v16.Skin;
import com.spineviewer.spine.runtime.v16.AnimationState.TrackEntry;
        ...
        for (int idx = skinNames.size() - 1; idx >= 0; idx--) {
            ...
            for (int i = 0; i < slotCount; i++) {
                ...
                for (int j = 0; j < names.size; j++) {
                    com.spineviewer.spine.runtime.v16.attachments.Attachment att = skin.getAttachment(i, names.get(j));
