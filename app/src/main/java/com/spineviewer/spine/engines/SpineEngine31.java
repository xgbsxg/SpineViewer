...
import com.spineviewer.spine.runtime.v31.Animation;
import com.spineviewer.spine.runtime.v31.AnimationState;
import com.spineviewer.spine.runtime.v31.AnimationStateData;
import com.spineviewer.spine.runtime.v31.Skeleton;
import com.spineviewer.spine.runtime.v31.SkeletonData;
import com.spineviewer.spine.runtime.v31.SkeletonJson;
import com.spineviewer.spine.runtime.v31.SkeletonRenderer;
import com.spineviewer.spine.runtime.v31.SkeletonRendererDebug;
import com.spineviewer.spine.runtime.v31.Skin;
...
public class SpineEngine31 extends AbstractSpineEngine {
    ...
    protected void loadSkeleton() throws Exception {
        ...
        if (fname.endsWith(".skel") || fname.endsWith(".bytes")) {
            throw new Exception("Spine 3.1 does not support binary (.skel) format.\n"
                    + "Please use the JSON (.json) skeleton file instead.");
        }
    ...
    protected void renderSkeleton(float delta) {
        ...
        if (animationState != null) {
            com.spineviewer.spine.runtime.v31.Animation current = animationState.getCurrent(0);
            if (current != null) {
        ...
        for (int idx = skinNames.size() - 1; idx >= 0; idx--) {
            ...
            for (int i = 0; i < slotCount; i++) {
                ...
                for (int j = 0; j < names.size; j++) {
                    com.spineviewer.spine.runtime.v31.attachments.Attachment att = skin.getAttachment(i, names.get(j));
