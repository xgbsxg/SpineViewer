...
import com.spineviewer.spine.runtime.v37.Animation;
import com.spineviewer.spine.runtime.v37.AnimationState;
import com.spineviewer.spine.runtime.v37.AnimationStateData;
import com.spineviewer.spine.runtime.v37.Skeleton;
import com.spineviewer.spine.runtime.v37.SkeletonData;
import com.spineviewer.spine.runtime.v37.SkeletonJson;
import com.spineviewer.spine.runtime.v37.SkeletonBinary;
import com.spineviewer.spine.runtime.v37.SkeletonRenderer;
import com.spineviewer.spine.runtime.v37.SkeletonRendererDebug;
import com.spineviewer.spine.runtime.v37.Skin;
...
public class SpineEngine37 extends AbstractSpineEngine {
    ...
    protected void renderSkeleton(float delta) {
        ...
        if (animationState != null) {
            com.spineviewer.spine.runtime.v37.Animation current = animationState.getCurrent(0);
            if (current != null) {
    ...
    public void setSkins(List<String> skinNames) {
        ...
        for (int i = skinNames.size() - 1; i >= 0; i--) {
            ...
            if (skin != null) combined.addAttachments(skin);
        }
        skeleton.setSkin(combined);
        skeleton.updateCache();
        var slots = skeleton.getSlots();
        var slotAtts = new com.badlogic.gdx.utils.Array<com.spineviewer.spine.runtime.v37.attachments.Attachment>();
        for (int i = 0, n = slots.size; i < n; i++) {
            slotAtts.clear();
            combined.findAttachmentsForSlot(i, slotAtts);
            if (slotAtts.size > 0)
                slots.get(i).setAttachment(slotAtts.get(0));
            else
