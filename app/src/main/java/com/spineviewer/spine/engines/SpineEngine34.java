...
import com.spineviewer.spine.runtime.v34.Animation;
import com.spineviewer.spine.runtime.v34.AnimationState;
import com.spineviewer.spine.runtime.v34.AnimationStateData;
import com.spineviewer.spine.runtime.v34.Skeleton;
import com.spineviewer.spine.runtime.v34.SkeletonData;
import com.spineviewer.spine.runtime.v34.SkeletonJson;
import com.spineviewer.spine.runtime.v34.SkeletonBinary;
import com.spineviewer.spine.runtime.v34.SkeletonRenderer;
import com.spineviewer.spine.runtime.v34.SkeletonRendererDebug;
import com.spineviewer.spine.runtime.v34.Skin;
...
public class SpineEngine34 extends AbstractSpineEngine {

    private TextureAtlas textureAtlas;
    private SkeletonRenderer<PolygonSpriteBatch> skeletonRenderer;
    ...
    protected void loadSkeleton() throws Exception {
        version = SpineVersion.V3_4;

        skeletonRenderer = new SkeletonRenderer<PolygonSpriteBatch>();
    ...
    protected void renderSkeleton(float delta) {
        ...
        if (animationState != null) {
            com.spineviewer.spine.runtime.v34.Animation current = animationState.getCurrent(0);
            if (current != null) {
        ...
        for (int idx = skinNames.size() - 1; idx >= 0; idx--) {
            ...
            for (int i = 0; i < slotCount; i++) {
                ...
                for (int j = 0; j < names.size; j++) {
                    com.spineviewer.spine.runtime.v34.attachments.Attachment att = skin.getAttachment(i, names.get(j));
