...
import com.spineviewer.spine.runtime.v17.Animation;
import com.spineviewer.spine.runtime.v17.AnimationState;
import com.spineviewer.spine.runtime.v17.AnimationStateData;
import com.spineviewer.spine.runtime.v17.Skeleton;
import com.spineviewer.spine.runtime.v17.SkeletonData;
import com.spineviewer.spine.runtime.v17.SkeletonJson;
import com.spineviewer.spine.runtime.v17.SkeletonBinary;
import com.spineviewer.spine.runtime.v17.SkeletonRenderer;
import com.spineviewer.spine.runtime.v17.SkeletonRendererDebug;
import com.spineviewer.spine.runtime.v17.Skin;
...
public class SpineEngine17 extends AbstractSpineEngine {
    ...
    protected void renderSkeleton(float delta) {
        ...
        if (animationState != null) {
            com.spineviewer.spine.runtime.v17.Animation current = animationState.getCurrent(0);
            if (current != null) {
        ...
        for (int idx = skinNames.size() - 1; idx >= 0; idx--) {
            ...
            for (int i = 0; i < slotCount; i++) {
                ...
                for (int j = 0; j < names.size; j++) {
                    com.spineviewer.spine.runtime.v17.attachments.Attachment att = skin.getAttachment(i, names.get(j));
