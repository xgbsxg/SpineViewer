...
import com.spineviewer.spine.runtime.v21.Animation;
import com.spineviewer.spine.runtime.v21.AnimationState;
import com.spineviewer.spine.runtime.v21.AnimationStateData;
import com.spineviewer.spine.runtime.v21.Skeleton;
import com.spineviewer.spine.runtime.v21.SkeletonData;
import com.spineviewer.spine.runtime.v21.SkeletonJson;
import com.spineviewer.spine.runtime.v21.SkeletonRenderer;
import com.spineviewer.spine.runtime.v21.SkeletonRendererDebug;
import com.spineviewer.spine.runtime.v21.Skin;
import com.spineviewer.spine.runtime.v21.AnimationState.TrackEntry;
...
public class SpineEngine21 extends AbstractSpineEngine {
    ...
    protected void loadSkeleton() throws Exception {
        ...
        if (fname.endsWith(".skel") || fname.endsWith(".bytes")) {
            throw new Exception("Spine 2.1 does not support binary (.skel) format.\n"
        ...
        for (int idx = skinNames.size() - 1; idx >= 0; idx--) {
            ...
            for (int i = 0; i < slotCount; i++) {
                ...
                for (int j = 0; j < names.size; j++) {
                    com.spineviewer.spine.runtime.v21.attachments.Attachment att = skin.getAttachment(i, names.get(j));
