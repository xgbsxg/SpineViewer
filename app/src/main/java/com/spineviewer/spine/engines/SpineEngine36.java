...
import com.spineviewer.spine.runtime.v36.Animation;
import com.spineviewer.spine.runtime.v36.AnimationState;
import com.spineviewer.spine.runtime.v36.AnimationStateData;
import com.spineviewer.spine.runtime.v36.Skeleton;
import com.spineviewer.spine.runtime.v36.SkeletonData;
import com.spineviewer.spine.runtime.v36.SkeletonJson;
import com.spineviewer.spine.runtime.v36.SkeletonBinary;
import com.spineviewer.spine.runtime.v36.SkeletonRenderer;
import com.spineviewer.spine.runtime.v36.SkeletonRendererDebug;
import com.spineviewer.spine.runtime.v36.Skin;
...
public class SpineEngine36 extends AbstractSpineEngine {
    ...
    protected void renderSkeleton(float delta) {
        ...
        if (animationState != null) {
            com.spineviewer.spine.runtime.v36.Animation current = animationState.getCurrent(0);
            if (current != null) {
        ...
        for (int idx = skinNames.size() - 1; idx >= 0; idx--) {
            ...
            for (int i = 0; i < slotCount; i++) {
                ...
                for (int j = 0; j < names.size; j++) {
                    ...
                    com.spineviewer.spine.runtime.v36.attachments.Attachment att = skin.getAttachment(i, attName);
