...
import com.spineviewer.spine.runtime.v43.AnimationState.TrackEntry;
...
public class SpineEngine43 extends AbstractSpineEngine {
    ...
    protected void loadSkeleton() throws Exception {
        ...
        skeletonRenderer.setPremultipliedAlphaColors(premultipliedAlpha);
    ...
    protected void renderSkeleton(float delta) {
        ...
        float duration = 0f;
        float progress = 0f;
        TrackEntry entry = animationState.getCurrent();
        if (entry != null) {
    ...
    public void setPremultipliedAlpha(boolean enabled) {
        ...
        if (skeletonRenderer != null) {
            skeletonRenderer.setPremultipliedAlphaColors(enabled);
        }
    }
